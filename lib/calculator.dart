...
class _BMICalculatorState extends State<BMICalculator> {
  ...
  CalCulate_BMI (String weight,String height) async{
    ...
    var res = (myDouble_weight/(myDouble_height*myDouble_height)*10000);

    setState(() {
      main_result.text = res.toStringAsFixed(2);
      if(res<18.5){
        myColor = Color(0xFFA07B02);
      }
      else if(res>=18.5 && res<=24.9){
        myColor = Color(0xFF06CE3B);
      }
      else if(res>=25 && res<=29.9){
        myColor = Color(0xFFCF5E01);
      }
      else if(res>=30 && res<=34.9){
        myColor = Color(0xFFEE2704);
      }
      else if(res>=35){
        myColor = Color(0xFFB60101);
      }
    });
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  Text("BMI Calculator",style: TextStyle(fontWeight: FontWeight.bold,color: Color(0xFFF3F3F2),fontSize: 25),),
                  SizedBox(
                    height: 30,
                  ),
